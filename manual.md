...
-   [Configuration functions](#configuration-functions)
    -   [gu_Set_Default_Task_Type(unsigned int type)](#gu_set_default_task_typeunsigned-int-type)
...
+===============================+==================+=====================+====================+=============+=======+
| Nios II Processor             | 1..NProcessors   | debug_mem_master    | 7FFH               | 0x0400_2800 | 3     |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_3000 |       |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_3800 |       |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| Nios II Avalon monitor module | 1                | s_Global            | FFH                | 0x0400_4200 | 5     |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_4300 |       |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| Nios II Avalon monitor module | 1..NProcessors   | s\$i                | 0x0 -- 0xFFFF_FFFF |             |       |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| Nios II Avalon bridge         | 1..NProcessors   | s\$i                | 0x0 -- 0xFFFF_FFFF |             |       |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| gRTOS                         | 1                | s_Global            | 1FFH               | 0x0400_4000 | 4     |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| gRTOS                         | 1..NProcessors   | s_processor\$i      | 7H                 | 0x0400_4420 | 7     |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_4428 |       |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_4430 |       |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| gRTOS                         | 1                | s_processor_monitor | 7H                 | 0x0400_4438 | 8     |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| JTAG UART Intel FPGA IP       | 0..NProcessors+1 | avalon_jtag_slave   | 7H                 | 0x0400_4440 | 9     |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_4448 |       |
|                               |                  |                     |                    |             |       |
|                               |                  |                     |                    | 0x0400_4450 |       |
...
|                               |                  |                     |                    | 0x0400_4460 |       |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| Interval Timer Intel FPGA IP  | 1                | s1                  | 1FH                | 0x0400_4400 | 6     |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| onchip_memory1_0              | 1                | s1                  | 7FFH               | 0x0400_2000 | 2     |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| onchip_memory1_1              | 1                | s1                  | 1FFFH              | 0x0400_0000 | 1     |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
| sysid_qsys_0                  | 1                | control_slave       | 7H                 | 0x0400_4468 | 10    |
+-------------------------------+------------------+---------------------+--------------------+-------------+-------+
...
+--------------------+---------------------------------------------------------------------------------------------+
| C1_MTX_GRN         | > C1_MTX_GRN signal is 0 when the R_MTX_PRC_GRN register is equal to 0; otherwise, it is 1. |
+====================+=============================================================================================+
| C1_NXT_EVN_PRC_ZRO |                                                                                             |
+--------------------+---------------------------------------------------------------------------------------------+
| R1_IRQ_PND         |                                                                                             |
...
-   Critical section is not granted to any processor (the C1_MTX_GRN signal is not set), the processor interrupt is enabled (the corresponding bit of the R_INT_ENB register is set) and:
    ...
    a.  the processor is executing the task associated with the next time event (the corresponding bit of the R_NXT_TM_EVN_PRC register is set) and a time event occurred (the C1_EVN_TM_OCC signal is set), or

    b.  the processor is executing the lowest priority task (the corresponding bit of the R_LOW_PRI_PRC register is set) and there is an IRQ request pending (the C1_IRQ_PND signal is set), or

    c.  the processor is executing the lowest priority task (the corresponding bit of the R_LOW_PRI_PRC register is set), a time event occurred (the C1_EVN_TM_OCC signal is set) and no processor is executing the next time event (the C1_EVN_TM_OCC signal is not set).
