...
struct rrds_producer {
    ...
    void  *pmsg;        ///< \brief Pointer to the message
...
struct rrds_consumer {
    ...
    void *buffer_msg;   ///< \brief Pointer to the consumer buffer as destination of the message sent
    G_INT32 buffer_length;  ///< \brief Length of the consumer buffer
