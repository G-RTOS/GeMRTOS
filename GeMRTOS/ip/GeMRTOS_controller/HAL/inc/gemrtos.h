...
// #define _impure_ptr (*(struct _reent **) (GRTOS_PROCESSOR_BASE + ADDR_REG_2))
...
// \brief G_NUMBER_OF_IRQ_TCB offset to add to the return offset because
...
// NIOSV_CLR_CSR(NIOSV_MSTATUS_CSR, NIOSV_MSTATUS_MIE_MASK)
...
#include <GNU_GRTOS_controller.h>
#endif // NOT  __niosX_arch__
...
#ifndef G_NUMBER_OF_IDLE_PROCESSORS
