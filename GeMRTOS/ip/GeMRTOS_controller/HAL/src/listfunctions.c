...
G_INT32 gk_ECBASL_Link(GS_ECB * const pevent, GS_SCB * const psignal)
{
	...
	G_INT32 retorno = gk_NODE_Link((void **) &pevent->ECB_NextECBASL,  // root to the ready list
					               ...
					               offsetof(GS_SCB, SCB_NextSCB),      // next field offset
					               offsetof(GS_SCB, SCB_NextSCB),      // previous field offset
					               offsetof(GS_SCB, SCBType),          // comparison field offset
					               G_FALSE,                            // dual-linked list
					               G_FALSE,                            // 64-bit comparison field
					               G_TRUE);                            // ascending order sorting
...
// 11-06-2024 void  gk_ECBASL_Link(GS_ECB * const pevent, GS_SCB * const psignal)
// 11-06-2024 {
// 11-06-2024     GK_SAMPLE_FUNCTION_BEGIN(4)
// 11-06-2024 
// 11-06-2024     GS_SCB *psignal2;
// 11-06-2024 
// 11-06-2024     if ((pevent->ECB_NextECBASL == (struct gs_scb *) 0) || (pevent->ECB_NextECBASL->SCBType > psignal->SCBType))
// 11-06-2024     {
// 11-06-2024         // it is the only SCB associated to pevent
// 11-06-2024     	psignal->SCB_NextSCB   = (struct gs_scb *) pevent->ECB_NextECBASL;
// 11-06-2024     	pevent->ECB_NextECBASL = (struct gs_scb *) psignal;
// 11-06-2024     }
// 11-06-2024     else 
// 11-06-2024     {
// 11-06-2024         // Sort by priotiy
// 11-06-2024         psignal2 = pevent->ECB_NextECBASL;
// 11-06-2024         while ((psignal2->SCB_NextSCB != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB->SCBType < psignal->SCBType))
// 11-06-2024         {
// 11-06-2024             PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_ECBASL_Link\n");
// 11-06-2024             psignal2 = psignal2->SCB_NextSCB;
// 11-06-2024         }
// 11-06-2024         psignal->SCB_NextSCB = psignal2->SCB_NextSCB;
// 11-06-2024         psignal2->SCB_NextSCB = psignal;
// 11-06-2024     }
// 11-06-2024     psignal->SCBState = G_SCBState_IN_ECB;
// 11-06-2024     GK_SAMPLE_FUNCTION_END(4)
// 11-06-2024 }
...
// CHECKING #############################################
    ...
    // 12-06-2024 if (pevent->ECB_NextECBASL == psignal)
    // 12-06-2024 {
    // 12-06-2024     // It is the fist ESB of the list
    // 12-06-2024 	pevent->ECB_NextECBASL = psignal->SCB_NextSCB;
	// 12-06-2024 	psignal->SCBState = G_SCBState_UNLINKED;
	// 12-06-2024 	retorno = G_TRUE;
    // 12-06-2024 }
    // 12-06-2024 else
    // 12-06-2024 {
    // 12-06-2024 	psignal2 = pevent->ECB_NextECBASL;
    // 12-06-2024 	while ((psignal2->SCB_NextSCB != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB != psignal))
    // 12-06-2024 	{
    // 12-06-2024 		psignal2 = psignal2->SCB_NextSCB;
    // 12-06-2024 	}
    // 12-06-2024     PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE), "ERROR signal not in ECBASL");
	// 12-06-2024 
	// 12-06-2024 	psignal2->SCB_NextSCB = psignal->SCB_NextSCB;
	// 12-06-2024 	psignal->SCBState = G_SCBState_UNLINKED;
	// 12-06-2024 	retorno = G_TRUE;
    // 12-06-2024 }
...
// 19-02-2024 {
// 19-02-2024 	GS_SCB *psignal1 = *root;
// 19-02-2024 	G_INT32 retorno = G_FALSE;
// 19-02-2024 	
// 19-02-2024 	if (psignal1 != (GS_SCB *) 0) {
// 19-02-2024 		if (psignal1 == psignal)
// 19-02-2024 		{
// 19-02-2024 			*root = psignal->SCB_NextSCB;
// 19-02-2024 			retorno = G_TRUE;
// 19-02-2024 		}
// 19-02-2024 		else
// 19-02-2024 		{
// 19-02-2024 			while ((psignal1->SCB_NextSCB != (struct gs_scb *) 0) && (psignal1->SCB_NextSCB != psignal))
// 19-02-2024 			{
// 19-02-2024 				PRINT_ASSERT((gkm_SCB_IsValid(psignal1) == G_TRUE),"ERROR psignal 2\n");
// 19-02-2024 				psignal1 = psignal1->SCB_NextSCB;
// 19-02-2024 			}
// 19-02-2024 			if (psignal1->SCB_NextSCB == psignal) {
// 19-02-2024 				PRINT_ASSERT((psignal1 == psignal),"ERROR psignal 3\n");
// 19-02-2024 				psignal1->SCB_NextSCB = psignal->SCB_NextSCB;
// 19-02-2024 				retorno = G_TRUE;
// 19-02-2024 			}
// 19-02-2024 		}
// 19-02-2024 		if (retorno == G_TRUE) {
// 19-02-2024 			psignal->SCBState = G_SCBState_UNLINKED;
// 19-02-2024 		}
// 19-02-2024 	}
// 19-02-2024 	return(retorno);
// 19-02-2024 }
...
G_INT32  gk_ECBTL_Link (GS_ECB *pevent)
{
	...
	gk_NODE_Link((void **) &g_kcb.KCB_NextECBTL,         // root to the ready list
				 (void *) pevent,                        // node to link
				 offsetof(GS_ECB, ECB_NextECB),          // next field offset
				 offsetof(GS_ECB, ECB_PrevECB),          // previous field offset
				 offsetof(GS_ECB, ECBValue.i64),         // comparison field offset
				 G_TRUE,                                 // dual-linked list
				 G_TRUE,                                 // 64-bit comparison field
				 G_TRUE);                                // ascending order sorting
...
G_INT32  gk_KCBASL_Link(GS_SCB *psignal)
{
	...
	// 19-06-2024 return gk_SCB_Link(&g_kcb.KCB_NextKCBASL, psignal, G_SCBState_IN_KCB, offsetof(GS_SCB, SCBType));
	return	(gk_NODE_Link((void **) &g_kcb.KCB_NextKCBASL,  // root to the ready list
					 (void *) psignal,                     // node to link
					 offsetof(GS_SCB, SCB_NextSCB),        // next field offset
					 offsetof(GS_SCB, SCB_NextSCB),        // previous field offset
					 offsetof(GS_SCB, SCBType),            // comparison field offset
...
// 10-06-2024 G_INT32  gk_KCBASL_Link(GS_SCB *psignal)
// 10-06-2024 {
// 10-06-2024     GK_SAMPLE_FUNCTION_BEGIN(10)
// 10-06-2024 
// 10-06-2024     GS_SCB *psignal2;
// 10-06-2024 
// 10-06-2024     if ((g_kcb.KCB_NextKCBASL == (struct gs_scb *) 0) || (g_kcb.KCB_NextKCBASL->SCBType > psignal->SCBType))
// 10-06-2024     {
// 10-06-2024         // it is the only SCB associated to pevent
// 10-06-2024     	psignal->SCB_NextSCB = g_kcb.KCB_NextKCBASL;
// 10-06-2024     	g_kcb.KCB_NextKCBASL = (struct gs_scb *)psignal;
// 10-06-2024     }
// 10-06-2024     else
// 10-06-2024     {
// 10-06-2024 		// Sort by priority
// 10-06-2024 		psignal2 = g_kcb.KCB_NextKCBASL;
// 10-06-2024 		while ((psignal2->SCB_NextSCB != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB->SCBType < psignal->SCBType))
// 10-06-2024 		{
// 10-06-2024 			PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_ECBASL_Link\n");
// 10-06-2024 			psignal2 = psignal2->SCB_NextSCB;
// 10-06-2024 		}
// 10-06-2024 		psignal->SCB_NextSCB = psignal2->SCB_NextSCB;
// 10-06-2024 		psignal2->SCB_NextSCB = psignal;
// 10-06-2024     }
// 10-06-2024     psignal->SCBState = G_SCBState_IN_KCB;
// 10-06-2024     GK_SAMPLE_FUNCTION_END(10)
// 10-06-2024     return(G_TRUE);
// 10-06-2024 }
...
G_INT32  gk_KCBASL_Unlink(GS_SCB *psignal)
{
    ...
    // 12-06-2024 if (g_kcb.KCB_NextKCBASL == psignal)
    // 12-06-2024 {
    // 12-06-2024     // It is the fist ESB of the list
    // 12-06-2024 	g_kcb.KCB_NextKCBASL = psignal->SCB_NextSCB;
	// 12-06-2024 	psignal->SCBState = G_SCBState_UNLINKED;
	// 12-06-2024 	retorno = G_TRUE;
    // 12-06-2024 }
    // 12-06-2024 else
    // 12-06-2024 {
    // 12-06-2024 	psignal2 = g_kcb.KCB_NextKCBASL;
    // 12-06-2024 	while ((psignal2->SCB_NextSCB != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB != psignal))
    // 12-06-2024 	{
    // 12-06-2024 		psignal2 = psignal2->SCB_NextSCB;
	// 12-06-2024 		PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_KCBASL_Unlink\n");
    // 12-06-2024 	}
    // 12-06-2024 	if (psignal2->SCB_NextSCB == psignal)
    // 12-06-2024 	{
    // 12-06-2024 		psignal2->SCB_NextSCB = psignal->SCB_NextSCB;
    // 12-06-2024 		psignal->SCBState = G_SCBState_UNLINKED;
    // 12-06-2024 		retorno = G_TRUE;
...
// 11-06-2024 G_INT32 gk_RCBASL_Link(G_RCB *presource, GS_SCB *psignal)
// 11-06-2024 {
// 11-06-2024     GK_SAMPLE_FUNCTION_BEGIN(16)
// 11-06-2024     GS_SCB *psignal2;
// 11-06-2024 
// 11-06-2024     if ((presource->RCB_NextRCBASL == (struct gs_scb *) 0) || (presource->RCB_NextRCBASL->SCBType > psignal->SCBType))
// 11-06-2024     {
// 11-06-2024         // it is the only SCB associated to pevent
// 11-06-2024     	psignal->SCB_NextSCB = presource->RCB_NextRCBASL;
// 11-06-2024     	presource->RCB_NextRCBASL = (struct gs_scb *) psignal;
// 11-06-2024     }
// 11-06-2024     else
// 11-06-2024     {
// 11-06-2024 		// Sort by priority
// 11-06-2024 		psignal2 = presource->RCB_NextRCBASL;
// 11-06-2024 		while ((psignal2->SCB_NextSCB != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB->SCBType < psignal->SCBType))
// 11-06-2024 		{
// 11-06-2024 			PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_ECBASL_Link\n");
// 11-06-2024 			psignal2 = psignal2->SCB_NextSCB;
...
// 11-06-2024 		psignal2->SCB_NextSCB = psignal;
// 11-06-2024     }
// 11-06-2024     psignal->SCBState = G_SCBState_IN_RCB;
// 11-06-2024     GK_SAMPLE_FUNCTION_END(16)
// 11-06-2024     return(G_TRUE);
// 11-06-2024 }
...
G_INT32 gk_RCBASL_Unlink(G_RCB *presource, GS_SCB *psignal)
{
	...
	if (retorno == G_TRUE) {
		...
		// 12-06-2024 if (presource->RCB_NextRCBASL == psignal)
		// 12-06-2024 {
		// 12-06-2024 	presource->RCB_NextRCBASL = psignal->SCB_NextSCB;
		// 12-06-2024 	psignal->SCBState = G_SCBState_UNLINKED;
		// 12-06-2024 	retorno = G_TRUE;
		// 12-06-2024 }
		// 12-06-2024 else
		// 12-06-2024 {
		// 12-06-2024 	psignal1 = presource->RCB_NextRCBASL;
		// 12-06-2024 	while ((psignal1->SCB_NextSCB != (struct gs_scb *) 0) && (psignal1->SCB_NextSCB != psignal))
		// 12-06-2024 	{
		// 12-06-2024 		psignal1 = psignal1->SCB_NextSCB;
		// 12-06-2024 	}
		// 12-06-2024 	if (psignal1->SCB_NextSCB == psignal)
		// 12-06-2024 	{
		// 12-06-2024 		psignal1->SCB_NextSCB = psignal->SCB_NextSCB;
		// 12-06-2024 		psignal->SCBState = G_SCBState_UNLINKED;
		// 12-06-2024 		retorno = G_TRUE;
		// 12-06-2024 	}
		// 12-06-2024 }
 ...
 *  \sa Event
 */
// 12-06-2024 GS_ECB *gk_RCBGEL_Link(G_RCB *presource, GS_TCB *ptcb, GS_ECB *pevent)
// 12-06-2024 {
// 12-06-2024 	return gk_RCBXEL_Link(&presource->RCB_NextRCBGEL, presource, ptcb, pevent, GS_ECBState_GRANTED_RESOURCE);
// 12-06-2024 }
...
GS_ECB *gk_RCBGEL_Link(G_RCB *presource, GS_TCB *ptcb, GS_ECB *pevent)
{
	...
	// 11-06-2024 if (get_pointed_field(pevent, ECB_RRDS) != (struct gs_rrds *) 0) set_pointed_field(pevent, ECBValue.i64, pevent->ECB_RRDS->RRDSGrantedPriority.i64);
	// 11-06-2024 else set_pointed_field(pevent, ECBValue.i64, (G_INT64) G_LOWEST_PRIORITY);

	/* Get the priority of the Event of highest priority */
	// pevent1 = get_pointed_field(presource, RCB_NextRCBGEL);
	
	// 19-06-2024 gk_ECB_ECBL_Link((GS_ECB **) &presource->RCB_NextRCBGEL, pevent);
	...
	// 12-06-2024 {
	// 12-06-2024     set_pointed_field(pevent, ECB_NextECB, (struct gs_ecb *) pevent1);
	// 12-06-2024     set_pointed_field(pevent, ECB_PrevECB, (struct gs_ecb *)0);
	// 12-06-2024 	if (pevent1 != (struct gs_ecb *) 0) set_pointed_field(pevent1, ECB_PrevECB,(struct gs_ecb *) pevent);
	// 12-06-2024     *root = pevent;
	// 12-06-2024 }
	// 12-06-2024 else 
	// 12-06-2024 {
	// 12-06-2024 	while ((get_pointed_field(pevent1, ECB_NextECB) != (struct gs_ecb *) 0) && (pevent1->ECB_NextECB->ECBValue.i64 <= pevent->ECBValue.i64))
	// 12-06-2024 	{
	// 12-06-2024 		pevent1 = get_pointed_field(pevent1, ECB_NextECB);
	// 12-06-2024 		PRINT_ASSERT((gkm_ECB_IsValid(pevent1) == G_TRUE),"ERROR ECB1 not valid\n");
	// 12-06-2024 	}
	// 12-06-2024 	set_pointed_field(pevent, ECB_NextECB, (struct gs_ecb *) get_pointed_field(pevent1, ECB_NextECB));
	// 12-06-2024 	set_pointed_field(pevent, ECB_PrevECB, pevent1);
	// 12-06-2024 	if (get_pointed_field(pevent1, ECB_NextECB) != (struct gs_ecb *) 0) set_pointed_field(get_pointed_field(pevent1,ECB_NextECB), ECB_PrevECB, pevent);
	// 12-06-2024 	set_pointed_field(pevent1, ECB_NextECB, (struct gs_ecb *) pevent);
	// 12-06-2024 }
...
// 12-06-2024 GS_ECB *gk_RCBXEL_Link(GS_ECB **root, G_RCB *presource, GS_TCB *ptcb, GS_ECB *pevent, enum ecbstate ECBState)
// 12-06-2024 {
// 12-06-2024     GK_SAMPLE_FUNCTION_BEGIN(10000)
// 12-06-2024 	/* Get the first event */
// 12-06-2024 	GS_ECB *pevent1 = *root;
// 12-06-2024 
// 12-06-2024 	PRINT_ASSERT((gkm_TCB_IsValid(ptcb) == G_TRUE),"ERROR ECB not valid\n");
// 12-06-2024 
// 12-06-2024 	// Get event if it is NULL
// 12-06-2024 	if (pevent == (struct gs_ecb *) 0)	pevent = gk_ECB_GetFree();
// 12-06-2024 	
// 12-06-2024 	PRINT_ASSERT((gkm_ECB_IsValid(pevent) == G_TRUE),"ERROR ECB not valid\n");
// 12-06-2024 
// 12-06-2024 	// Set the priority of the event
// 12-06-2024 	set_pointed_field(pevent, ECBValue.i64, ptcb->TCBCurrentPriority);
// 12-06-2024 	
// 12-06-2024 	gk_ECB_ECBL_Link(root, pevent);
// 12-06-2024 	// if ((pevent1 == (struct gs_ecb *) 0) || (pevent1->ECBValue.i64 > pevent->ECBValue.i64))
// 12-06-2024 	// {
// 12-06-2024 	//     pevent->ECB_NextECB = (struct gs_ecb *) pevent1;
...
// 12-06-2024 	
// 12-06-2024 	
// 12-06-2024 	pevent->ECBState = ECBState;
// 12-06-2024 	pevent->ECB_AssocRCB = (struct g_rcb *) presource;
// 12-06-2024     GK_SAMPLE_FUNCTION_END(10000)
// 12-06-2024     return(pevent);
// 12-06-2024 }


// 19-06-2024 GS_ECB *gk_ECB_ECBL_Link(GS_ECB **root, GS_ECB *pevent)
// 19-06-2024 {
// 19-06-2024 	GS_ECB *pevent1 = *root;
// 19-06-2024 	PRINT_ASSERT((gkm_ECB_IsValid(pevent) == G_TRUE),"ERROR ECB not valid\n");
// 19-06-2024 	PRINT_ASSERT(((gkm_ECB_IsValid(pevent1) == G_TRUE) || (pevent1 == (struct gs_ecb *) 0)),"ERROR ECB not valid\n");
// 19-06-2024 	
// 19-06-2024 	if ((pevent1 == (struct gs_ecb *) 0) || (pevent1->ECBValue.i64 > pevent->ECBValue.i64))
// 19-06-2024 	{
// 19-06-2024 	    pevent->ECB_NextECB = (struct gs_ecb *) pevent1;
// 19-06-2024 	    pevent->ECB_PrevECB = (struct gs_ecb *) 0;
// 19-06-2024 		if (pevent1 != (struct gs_ecb *) 0) pevent1->ECB_PrevECB = (struct gs_ecb *) pevent;
// 19-06-2024 	    *root = (struct gs_ecb *) pevent;
// 19-06-2024 	}
// 19-06-2024 	else
// 19-06-2024 	{
// 19-06-2024 		while ((pevent1->ECB_NextECB != (struct gs_ecb *) 0) && (pevent1->ECB_NextECB->ECBValue.i64 <= pevent->ECBValue.i64)) {
// 19-06-2024 			pevent1 = pevent1->ECB_NextECB;
// 19-06-2024 			PRINT_ASSERT((gkm_ECB_IsValid(pevent1) == G_TRUE),"ERROR ECB not valid\n");
// 19-06-2024 		}
// 19-06-2024 		pevent->ECB_NextECB = pevent1->ECB_NextECB;
// 19-06-2024 		pevent->ECB_PrevECB = pevent1;
// 19-06-2024 		if (pevent1->ECB_NextECB != (struct gs_ecb *) 0) pevent1->ECB_NextECB->ECB_PrevECB = pevent;
// 19-06-2024 		pevent1->ECB_NextECB = pevent;
// 19-06-2024 	}
// 19-06-2024     return(pevent);
// 19-06-2024 }
...
// 19-06-2024 	GS_ECB *pevent1 = *root;
// 19-06-2024 
// 19-06-2024 	if (*root == pevent) {
// 19-06-2024 		*root = pevent->ECB_NextECB;
// 19-06-2024 	} else {
// 19-06-2024         PRINT_ASSERT((pevent->ECB_PrevECB != (struct gs_ecb *) 0),"ERROR in gk_RCBGEL_Unlink");
// 19-06-2024         pevent->ECB_PrevECB->ECB_NextECB = pevent->ECB_NextECB;
// 19-06-2024 	}
// 19-06-2024     if (pevent->ECB_NextECB != (struct gs_ecb *) 0) pevent->ECB_NextECB->ECB_PrevECB = pevent->ECB_PrevECB;
// 19-06-2024 
// 19-06-2024 	/* Set the pointer to unlinked */
// 19-06-2024 	pevent->ECBState = GS_ECBState_UNLINKED;
// 19-06-2024 	pevent->ECB_PrevECB = (struct gs_ecb *) 0;
// 19-06-2024 	pevent->ECB_NextECB = (struct gs_ecb *) 0;
// 19-06-2024 
// 19-06-2024     return(pevent);
// 19-06-2024 }
 ...
 *  \sa Event
 */
// 12-06-2024 GS_ECB *gk_RCBWEL_Link(G_RCB *presource, GS_TCB *ptcb, GS_ECB *pevent)
// 12-06-2024 {
// 12-06-2024 	return gk_RCBXEL_Link(&presource->RCB_NextRCBWEL, presource, ptcb, pevent, GS_ECBState_WAITING_RESOURCE);
// 12-06-2024 }
...
void gk_RCBWEL_Unlink(GS_ECB *pevent)
{
	...
	// 12-06-2024if (get_pointed_field(presource, RCB_NextRCBWEL) == pevent)
	// 12-06-2024{
	// 12-06-2024	set_pointed_field(presource, RCB_NextRCBWEL, get_pointed_field(pevent, ECB_NextECB));
	// 12-06-2024	if (get_pointed_field(presource, RCB_NextRCBWEL) !=  (struct gs_ecb *) 0) 
	// 12-06-2024		set_pointed_field(get_pointed_field(presource,RCB_NextRCBWEL), ECB_PrevECB,(struct gs_ecb *) 0);
	// 12-06-2024} else
	// 12-06-2024{
    // 12-06-2024    PRINT_ASSERT((pevent->ECB_PrevECB != (struct gs_ecb *) 0), "ERROR in gk_RCBWEL_Unlink");
    // 12-06-2024    set_pointed_field(get_pointed_field(pevent, ECB_PrevECB), ECB_NextECB, get_pointed_field(pevent,ECB_NextECB));
    // 12-06-2024    if (get_pointed_field(pevent, ECB_NextECB) != (struct gs_ecb *) 0) {
    // 12-06-2024        set_pointed_field(get_pointed_field(pevent, ECB_NextECB), ECB_PrevECB, get_pointed_field(pevent, ECB_PrevECB));
    // 12-06-2024    }
	// 12-06-2024}
	// 12-06-2024/* Set the pointer to unlinked */
	// 12-06-2024set_pointed_field(pevent, ECBState, GS_ECBState_UNLINKED);
	// 12-06-2024set_pointed_field(pevent, ECB_PrevECB, (struct gs_ecb *) 0);
	// 12-06-2024set_pointed_field(pevent, ECB_NextECB, (struct gs_ecb *) 0);
...
GS_SCB *gk_SCB_Copy(GS_SCB *psignal)
{
    ...
    if (psignal1 != (struct gs_scb *) 0){
        ...
        set_pointed_field(psignal1, SCB_NextSCBAPSL , (struct gs_scb *) 0);
...
G_INT32 gk_SCBAPSL_UnLink(GS_SCB *pscb_root, GS_SCB *pscb_pending)
{
	...
	// 02-07-2024 PRINT_ASSERT((pscb_pending->SCBState != G_SCBState_EXECUTING), "Unlinking executing signal");
	// 02-07-2024 if (pscb_pending->SCBState == G_SCBState_EXECUTING) return(G_FALSE);

	// 19-06-2024 if (pscb_root->SCB_NextSCBAPSL == pscb_pending)
	// 19-06-2024 {
	// 19-06-2024 	pscb_root->SCB_NextSCBAPSL = pscb_pending->SCB_NextSCBAPSL;
	// 19-06-2024 }
	// 19-06-2024 else
	// 19-06-2024 {
	// 19-06-2024 	pscb = pscb_root->SCB_NextSCBAPSL;
	// 19-06-2024 	while (pscb != (struct gs_scb *) 0)
	// 19-06-2024 	{
	// 19-06-2024 		if (pscb->SCB_NextSCBAPSL == pscb_pending)
	// 19-06-2024 		{
	// 19-06-2024 			pscb->SCB_NextSCBAPSL = pscb_pending->SCB_NextSCBAPSL;
	// 19-06-2024 			pscb = (struct gs_scb *) 0;
	// 19-06-2024 		}
	// 19-06-2024 		else
	// 19-06-2024 		{
	// 19-06-2024 			pscb = pscb->SCB_NextSCBAPSL;
	// 19-06-2024 		}
	// 19-06-2024 	}
	// 19-06-2024 }
	
	G_INT32 retorno = gk_NODE_SINGLE_Unlink((void **) &pscb_root->SCB_NextSCBAPSL, // root to the ready list
									(void *) pscb_pending,                         // node to link
									(G_INT32)  offsetof(GS_SCB,SCB_NextSCBAPSL));  // next field offset
	if (retorno == G_TRUE) {
...
// 11-06-2024 G_INT32 gk_TCBASL_Link(GS_TCB *ptcb, GS_SCB *psignal)
// 11-06-2024 {
// 11-06-2024     GK_SAMPLE_FUNCTION_BEGIN(10044)
// 11-06-2024     G_INT32 priority = get_pointed_field(psignal, SCBType);
// 11-06-2024     GS_SCB *psignal2;
// 11-06-2024 
// 11-06-2024     if ((get_pointed_field(ptcb, TCB_NextTCBASL) == (struct gs_scb *) 0) || (get_pointed_field(get_pointed_field(ptcb, TCB_NextTCBASL), SCBType) > priority))
// 11-06-2024     {
// 11-06-2024         // it is the only SCB associated to pevent
// 11-06-2024     	set_pointed_field(psignal, SCB_NextSCB, (GS_SCB *) get_pointed_field(ptcb, TCB_NextTCBASL));
// 11-06-2024     	set_pointed_field(ptcb, TCB_NextTCBASL, (struct gs_scb *) psignal);
// 11-06-2024     }
// 11-06-2024 	else
// 11-06-2024 	{
// 11-06-2024 		// Sort by priotiy
// 11-06-2024 		psignal2 = (GS_SCB *) get_pointed_field(ptcb, TCB_NextTCBASL);
// 11-06-2024 		while ((get_pointed_field(psignal2, SCB_NextSCB) != (struct gs_scb *) 0) && (get_pointed_field(get_pointed_field(psignal2, SCB_NextSCB), SCBType) <= priority))
// 11-06-2024 		{
// 11-06-2024 			PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_TCBASL_Link\n");
// 11-06-2024 			psignal2 = get_pointed_field(psignal2, SCB_NextSCB);
// 11-06-2024 		}
// 11-06-2024 		PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_TCBASL_Link2\n");
// 11-06-2024 		set_pointed_field(psignal, SCB_NextSCB, get_pointed_field(psignal2, SCB_NextSCB));
// 11-06-2024 		set_pointed_field(psignal2, SCB_NextSCB, (struct gs_scb *) psignal);
// 11-06-2024     }
// 11-06-2024 	set_pointed_field(psignal, SCBState, G_SCBState_IN_TCB);
// 11-06-2024     GK_SAMPLE_FUNCTION_END(10044)
// 11-06-2024     return(G_TRUE);
// 11-06-2024 }

// 19-06-2024 G_INT32 gk_SCB_Link(GS_SCB **root, GS_SCB *psignal, enum scbstate State, G_INT32 offset_priority)
// 19-06-2024 {
// 19-06-2024 	// rewrite G_INT32 priority = psignal->SCBType;
// 19-06-2024 	G_INT32 priority = *(G_INT32 *) ((char *) psignal + offset_priority);
// 19-06-2024 	GS_SCB *psignal1 = *root;
// 19-06-2024     GS_SCB *psignal2;
// 19-06-2024 	
// 19-06-2024     // rewrite if ((psignal1 == (struct gs_scb *) 0) || (psignal1->SCBType > priority))
// 19-06-2024 	if ((psignal1 == (struct gs_scb *) 0) || (*(G_INT32 *) ((char *) psignal1 + offset_priority) > priority))
// 19-06-2024     {
// 19-06-2024         // it is the only SCB associated to pevent
// 19-06-2024     	set_pointed_field(psignal, SCB_NextSCB, (struct gs_scb *) psignal1);
// 19-06-2024     	*root  = psignal;
// 19-06-2024     }
// 19-06-2024 	else
// 19-06-2024 	{
// 19-06-2024 		// Sort by priotiy
// 19-06-2024 		psignal2 = psignal1;
// 19-06-2024 		// rewrite while ((get_pointed_field(psignal2, SCB_NextSCB) != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB->SCBType <= priority))
// 19-06-2024 		while ((get_pointed_field(psignal2, SCB_NextSCB) != (struct gs_scb *) 0) && (*(G_INT32 *) ((char *) psignal2->SCB_NextSCB + offset_priority) <= priority))
// 19-06-2024 		{
// 19-06-2024 			psignal2 = psignal2->SCB_NextSCB;
// 19-06-2024 		}
// 19-06-2024 		PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_RRDSASL_Link\n");
// 19-06-2024 		set_pointed_field(psignal, SCB_NextSCB, get_pointed_field(psignal2,SCB_NextSCB));
// 19-06-2024 		set_pointed_field(psignal2, SCB_NextSCB, (struct gs_scb *) psignal);
// 19-06-2024     }
// 19-06-2024 	
// 19-06-2024 	set_pointed_field(psignal,SCBState, State);
// 19-06-2024     return(G_TRUE);
// 19-06-2024 }


// 11-06-2024G_INT32 gk_SCB_Link(GS_SCB **root, GS_SCB *psignal, enum scbstate State)
// 11-06-2024{
// 11-06-2024	G_INT32 priority = psignal->SCBType;
// 11-06-2024	GS_SCB *psignal1 = *root;
// 11-06-2024    GS_SCB *psignal2;
// 11-06-2024	
// 11-06-2024    if ((psignal1 == (struct gs_scb *) 0) || (psignal1->SCBType > priority))
// 11-06-2024    {
// 11-06-2024        // it is the only SCB associated to pevent
// 11-06-2024    	set_pointed_field(psignal, SCB_NextSCB, (struct gs_scb *) psignal1);
// 11-06-2024    	*root  = psignal;
// 11-06-2024    }
// 11-06-2024	else
// 11-06-2024	{
// 11-06-2024		// Sort by priotiy
// 11-06-2024		psignal2 = psignal1;
// 11-06-2024		while ((get_pointed_field(psignal2, SCB_NextSCB) != (struct gs_scb *) 0) && (get_pointed_field(get_pointed_field(psignal2, SCB_NextSCB), SCBType) <= priority))
// 11-06-2024		{
// 11-06-2024			psignal2 = psignal2->SCB_NextSCB;
// 11-06-2024		}
// 11-06-2024		PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_RRDSASL_Link\n");
// 11-06-2024		set_pointed_field(psignal, SCB_NextSCB, get_pointed_field(psignal2,SCB_NextSCB));
// 11-06-2024		set_pointed_field(psignal2, SCB_NextSCB, (struct gs_scb *) psignal);
// 11-06-2024    }
// 11-06-2024	
// 11-06-2024	set_pointed_field(psignal,SCBState, State);
// 11-06-2024    return(G_TRUE);
// 11-06-2024}
...
G_INT32  gk_TCBASL_Unlink(GS_TCB *ptcb, GS_SCB *psignal)
{
	...
	if (retorno == G_TRUE) {
		...
		// 12-06-2024 if (ptcb->TCB_NextTCBASL == psignal)
		// 12-06-2024 {
		// 12-06-2024 	ptcb->TCB_NextTCBASL = psignal->SCB_NextSCB;
		// 12-06-2024 }
		// 12-06-2024 else
		// 12-06-2024 {
		// 12-06-2024 	psignal1 = (GS_SCB *) ptcb->TCB_NextTCBASL;
		// 12-06-2024 	while ((psignal1->SCB_NextSCB != (struct gs_scb *) 0) && (psignal1->SCB_NextSCB != psignal))
		// 12-06-2024 	{
		// 12-06-2024 		PRINT_ASSERT((gkm_SCB_IsValid(psignal1) == G_TRUE),"ERROR psignal 2\n");
		// 12-06-2024 		psignal1 = psignal1->SCB_NextSCB;
		// 12-06-2024 	}
		// 12-06-2024 	PRINT_ASSERT((psignal1 == psignal),"ERROR psignal 3\n");
		// 12-06-2024 	psignal1->SCB_NextSCB = psignal->SCB_NextSCB;
		// 12-06-2024 }
		// 12-06-2024 psignal->SCBState = G_SCBState_UNLINKED;
	// 12-06-2024 }
...
G_INT32  gk_TCBPSL_Link(GS_TCB *ptcb, GS_SCB *psignal)
{
	...
	// 19-06-2024 return gk_SCB_Link(&ptcb->TCB_NextTCBPSL, psignal, G_SCBState_PENDING, offsetof(GS_SCB, SCBPriority));
	return	(gk_NODE_Link((void **) &ptcb->TCB_NextTCBPSL,       // root to the ready list
		                 (void *) psignal,                      // node to link
					     offsetof(GS_SCB, SCB_NextSCB),         // next field offset
					     offsetof(GS_SCB, SCB_NextSCB),         // previous field offset
					     offsetof(GS_SCB, SCBType),             // comparison field offset
...
// G_INT32  gk_TCBPSL_Link(GS_TCB *ptcb, GS_SCB *psignal)
// {
//     GK_SAMPLE_FUNCTION_BEGIN(10035)
//     G_INT32 priority;
//     GS_SCB *psignal2;
// 
// 	priority = get_pointed_field(psignal, SCBPriority);
//     if ((get_pointed_field(ptcb, TCB_NextTCBPSL) == (struct gs_scb *) 0) || (get_pointed_field(get_pointed_field(ptcb, TCB_NextTCBPSL), SCBPriority) > priority))
//     {
//     	set_pointed_field(psignal, SCB_NextSCB, (struct gs_scb *) get_pointed_field(ptcb, TCB_NextTCBPSL));
//     	set_pointed_field(ptcb, TCB_NextTCBPSL, (struct gs_scb *) psignal);
//     }
// 	else
// 	{
// 		psignal2 = (GS_SCB *) get_pointed_field(ptcb, TCB_NextTCBPSL);
// 		while ((get_pointed_field(psignal2, SCB_NextSCB) != (struct gs_scb *) 0) && (get_pointed_field(get_pointed_field(psignal2, SCB_NextSCB), SCBPriority) <= priority))
// 		{
// 			psignal2 = get_pointed_field(psignal2, SCB_NextSCB);
// 		}
// 		set_pointed_field(psignal, SCB_NextSCB, get_pointed_field(psignal2, SCB_NextSCB));
// 		set_pointed_field(psignal2, SCB_NextSCB, (struct gs_scb *) psignal);
// 
//     }
// 	set_pointed_field(psignal, SCBState, G_SCBState_PENDING);
//     GK_SAMPLE_FUNCTION_END(10035)
//     return(G_TRUE);
// }
...
G_INT32  gk_TCBPSL_Unlink(GS_TCB *ptcb, GS_SCB *psignal)
{
	...
	// 12-06-2024 if (get_pointed_field(ptcb, TCB_NextTCBPSL) != (struct gs_scb *) 0)
	// 12-06-2024 {
		
		
	// 19-06-2024 retorno = gk_SCB_SCBL_Unlink((GS_SCB **) &ptcb->TCB_NextTCBPSL, psignal);
	...
	if (retorno == G_TRUE) {
		...
		// 12-06-2024 if (get_pointed_field(ptcb, TCB_NextTCBPSL) == psignal)
		// 12-06-2024 {
		// 12-06-2024 	set_pointed_field(ptcb, TCB_NextTCBPSL, get_pointed_field(psignal, SCB_NextSCB));
		// 12-06-2024 }
		// 12-06-2024 else
		// 12-06-2024 {
		// 12-06-2024 	psignal1 = (GS_SCB *) get_pointed_field(ptcb, TCB_NextTCBPSL);
		// 12-06-2024 	while ((get_pointed_field(psignal1, SCB_NextSCB) != (struct gs_scb *) 0) && (get_pointed_field(psignal1, SCB_NextSCB) != psignal))
		// 12-06-2024 	{
		// 12-06-2024 		psignal1 = get_pointed_field(psignal1, SCB_NextSCB);
		// 12-06-2024 		PRINT_ASSERT((gkm_SCB_IsValid(psignal1) == G_TRUE),"ERROR psignal in gk_TCBPSL_Unlink\n");  
		// 12-06-2024 	}
		// 12-06-2024 	PRINT_ASSERT((psignal1->SCB_NextSCB == psignal),"ERROR psignal in gk_TCBPSL_Unlink 2\n");
		// 12-06-2024 	set_pointed_field(psignal1, SCB_NextSCB,  get_pointed_field(psignal, SCB_NextSCB));
		// 12-06-2024 }
		// 12-06-2024 set_pointed_field(psignal, SCBState, G_SCBState_UNLINKED);
    // 12-06-2024 }
...
G_INT32 gk_TCBRDYL_Link(GS_TCB * const ptcb)
{
	...
	if (get_pointed_field(ptcb, TCBType) != G_TCBType_IDLE) /* Idle task are not inserted in Ready Lists */
	{
		gk_NODE_Link((void **) &readylist->LCB_NextTCBRDYL,  // root to the ready list
		             (void *) ptcb,                          // node to link
					 offsetof(GS_TCB, TCB_NextTCB),          // next field offset
					 offsetof(GS_TCB, TCB_PrevTCB),          // previous field offset
					 offsetof(GS_TCB, TCBReadyPriority),     // comparison field offset
					 G_TRUE,                                 // dual-linked list
					 G_TRUE,                                 // 64-bit comparison field
					 G_TRUE);                                // ascending order sorting
...
G_INT32  gk_TCBRUNL_Link(GS_TCB *ptcb)
{
	...
	GS_PCB *ppcb = (GS_PCB *) &g_kcb.G_PCBTbl[GRTOS_CMD_PRC_ID -1];
	
    PRINT_ASSERT(((ptcb1 == (struct gs_tcb *) 0) || (gkm_TCB_IsValid(ptcb1) == G_TRUE)),"ERROR TCB not valid\n");
    PRINT_ASSERT((ptcb->TCBState == G_TCBState_UNLINKED),"ERROR TCBState= %d\n",(int) ptcb->TCBState);    
	...
	gk_NODE_Link((void **) &RunList->LCB_NextTCBRUNL,      // root to the ready list
				 ...
				 offsetof(GS_TCB, TCB_NextTCB),            // next field offset
				 offsetof(GS_TCB, TCB_PrevTCB),            // previous field offset
				 offsetof(GS_TCB, TCBRunPriority),         // comparison field offset
				 G_TRUE,                                   // dual-linked list
				 G_TRUE,                                   // 64-bit comparison field
				 G_FALSE);                                 // ascending order sorting


	// 11-06-2024 ptcb1 = get_pointed_field(RunList, LCB_NextTCBRUNL);
	// 11-06-2024 if ((ptcb1 == (struct gs_tcb *) 0) || (ptcb->TCBCurrentPriority > ptcb1->TCBCurrentPriority))
	// 11-06-2024 {
	// 11-06-2024 	/* It is the first element in the running list */
	// 11-06-2024 	set_pointed_field(ptcb, TCB_NextTCB, (struct gs_tcb *) ptcb1);
	// 11-06-2024 	set_pointed_field(ptcb, TCB_PrevTCB, (struct gs_tcb *) 0);
	// 11-06-2024 	if (ptcb1 != (struct gs_tcb *) 0)
	// 11-06-2024 		set_pointed_field(ptcb1, TCB_PrevTCB, (struct gs_tcb *) ptcb);
	// 11-06-2024 	set_pointed_field(RunList, LCB_NextTCBRUNL, (struct gs_tcb *) ptcb); 
	// 11-06-2024 }
	// 11-06-2024 else
	// 11-06-2024 {
	// 11-06-2024 	PRINT_ASSERT((gkm_TCB_IsValid(ptcb1) == G_TRUE),"ERROR TCB not valid ptcb= %p\n", (void *) ptcb1);
	// 11-06-2024 
	// 11-06-2024 	/* Search the place in the list to insert ptcb */
	// 11-06-2024 	while ((get_pointed_field(ptcb1,TCB_NextTCB) != (struct gs_tcb *) 0) && (ptcb1->TCB_NextTCB->TCBCurrentPriority > ptcb->TCBCurrentPriority))
	// 11-06-2024 	{
	// 11-06-2024 		ptcb1 = (GS_TCB *) get_pointed_field(ptcb1, TCB_NextTCB);
	// 11-06-2024 	}
	// 11-06-2024 	set_pointed_field(ptcb, TCB_NextTCB, get_pointed_field(ptcb1, TCB_NextTCB));
	// 11-06-2024 	set_pointed_field(ptcb, TCB_PrevTCB, (struct gs_tcb *) ptcb1);
	// 11-06-2024 	if (get_pointed_field(ptcb1, TCB_NextTCB) != (struct gs_tcb *) 0)
	// 11-06-2024 		set_pointed_field(get_pointed_field(ptcb1, TCB_NextTCB), TCB_PrevTCB, ptcb);
	// 11-06-2024 	set_pointed_field(ptcb1, TCB_NextTCB, ptcb);
	// 11-06-2024 }

    set_pointed_field(ptcb, TCBState, G_TCBState_RUNNING); 
	set_pointed_field(ppcb, PCB_EXECTCB, (struct gs_tcb *) ptcb);
    set_pointed_field(ptcb, TCB_AssocPCB, GRTOS_CMD_PRC_ID);
    ...
    if ((get_pointed_field(ptcb, TCB_RDY_LCB_Index) != (GS_LCB *) get_pointed_field(get_pointed_field(ppcb,PCB_AssocLCB),PCB_RDY_LCBL)) || (get_pointed_field(ptcb, TCBType) == G_TCBType_IDLE))
	{
		if (get_pointed_field(ppcb, PCBState) != GS_PCBState_FREE)
	        gk_LCBFPL_Link(GRTOS_CMD_PRC_ID); // Link the processor to the free list
	}
    else
	{
        // Si esta en la lista de ready principal del procesador, entocnes es sacado de la lista de libres        
		if (get_pointed_field(ppcb, PCBState) == GS_PCBState_FREE)
		    gk_LCBFPL_Unlink((G_INT32) GRTOS_CMD_PRC_ID); // Unlink the processor from the free list
	}
...
G_INT32 gk_NODE_Link(void **root, void * const ptcb, G_INT32 const offset_next, G_INT32 const offset_prev, G_INT32 const offset_value, G_INT32 const dual_linked, G_INT32 const data64, G_INT32 const asc_sort)
{
	void *ptcb1 = *root;

	// Not equal is logical XOR
	// if ((ptcb1 == (struct gs_tcb *) 0) || ((asc_sort == G_FALSE) != (ptcb1->TCBCurrentPriority > ptcb->TCBCurrentPriority)))
	if (((data64 == G_TRUE) && ((ptcb1 == (void *) 0) || ((asc_sort == G_FALSE) != (get_pointed_offset(G_INT64,ptcb1,offset_value) > get_pointed_offset(G_INT64,ptcb,offset_value))))) || ((data64 == G_FALSE) && ((ptcb1 == (void *) 0) || ((asc_sort == G_FALSE) != (get_pointed_offset(G_INT32,ptcb1,offset_value) > get_pointed_offset(G_INT32,ptcb,offset_value))))))
	{// It is the first TCB to insert
		...
		*root = (void *) ptcb; 
		...
		while (((data64 == G_TRUE) && ((get_pointed_offset(void *,ptcb1,offset_next) != (void *) 0) && ((asc_sort == G_TRUE) != (get_pointed_offset(G_INT64,get_pointed_offset(void *,ptcb1,offset_next),offset_value) > get_pointed_offset(G_INT64,ptcb,offset_value))))) || ((data64 == G_FALSE) && ((get_pointed_offset(void *,ptcb1,offset_next) != (void *) 0) && ((asc_sort == G_TRUE) != (get_pointed_offset(G_INT32,get_pointed_offset(void *,ptcb1,offset_next),offset_value) > get_pointed_offset(G_INT32,ptcb,offset_value))))))
		{
...
// 18-06-2024 G_INT32 gk_TCBRDYLRUN_Link(GS_TCB **root, GS_TCB * const ptcb, G_INT32 asc_sort)
// 18-06-2024 {
// 18-06-2024 	void *ptcb1 = *root;
// 18-06-2024 
// 18-06-2024 	// Not equal is logical XOR
// 18-06-2024 	// if ((ptcb1 == (struct gs_tcb *) 0) || ((asc_sort == G_FALSE) != (ptcb1->TCBCurrentPriority > ptcb->TCBCurrentPriority)))
// 18-06-2024 	if ((ptcb1 == (void *) 0) || ((asc_sort == G_FALSE) != (get_pointed_offset(G_INT64,ptcb1,offsetof(GS_TCB, TCBCurrentPriority)) > get_pointed_offset(G_INT64,ptcb,offsetof(GS_TCB, TCBCurrentPriority)))))		
// 18-06-2024 	{// It is the first TCB to insert
// 18-06-2024 		// ptcb->TCB_NextTCB = (struct gs_tcb *) ptcb1;
// 18-06-2024 		get_pointed_offset(struct gs_tcb *,ptcb,offsetof(GS_TCB, TCB_NextTCB)) = (struct gs_tcb *) ptcb1;
// 18-06-2024 		// ptcb->TCB_PrevTCB = (struct gs_tcb *) 0;
// 18-06-2024 		get_pointed_offset(struct gs_tcb *,ptcb,offsetof(GS_TCB, TCB_PrevTCB)) = (struct gs_tcb *) 0;
// 18-06-2024 		if (ptcb1 != (void *) 0) {
// 18-06-2024 			// ptcb->TCB_NextTCB->TCB_PrevTCB = (struct gs_tcb *) ptcb;
// 18-06-2024 			get_pointed_offset(struct gs_tcb *,get_pointed_offset(struct gs_tcb *,ptcb,offsetof(GS_TCB, TCB_NextTCB)),offsetof(GS_TCB, TCB_PrevTCB)) = (struct gs_tcb *) ptcb;
// 18-06-2024 		}
// 18-06-2024 		*root = (struct gs_tcb *) ptcb; 
// 18-06-2024 	}
// 18-06-2024 	else {
// 18-06-2024 		// while ((ptcb1->TCB_NextTCB != (struct gs_tcb *) 0) && ((asc_sort == G_TRUE) != (ptcb1->TCB_NextTCB->TCBCurrentPriority > ptcb->TCBCurrentPriority)))
// 18-06-2024 		while ((get_pointed_offset(struct gs_tcb *,ptcb1,offsetof(GS_TCB, TCB_NextTCB)) != (struct gs_tcb *) 0) && ((asc_sort == G_TRUE) != (get_pointed_offset(G_INT64,get_pointed_offset(struct gs_tcb *,ptcb1,offsetof(GS_TCB, TCB_NextTCB)),offsetof(GS_TCB, TCBCurrentPriority)) > get_pointed_offset(G_INT64,ptcb,offsetof(GS_TCB, TCBCurrentPriority)))))			
// 18-06-2024 		{
// 18-06-2024 			// ptcb1 = (GS_TCB *) ptcb1->TCB_NextTCB;
// 18-06-2024 			ptcb1 = (void *) get_pointed_offset(struct gs_tcb *,ptcb1,offsetof(GS_TCB, TCB_NextTCB));
// 18-06-2024 		}		
// 18-06-2024 		// ptcb->TCB_NextTCB = ptcb1->TCB_NextTCB;
// 18-06-2024 		get_pointed_offset(void *,ptcb,offsetof(GS_TCB, TCB_NextTCB)) = get_pointed_offset(void *,ptcb1,offsetof(GS_TCB, TCB_NextTCB));
// 18-06-2024 		// if (ptcb->TCB_NextTCB != (struct gs_tcb *) 0) ptcb->TCB_NextTCB->TCB_PrevTCB = ptcb;
// 18-06-2024 		if (get_pointed_offset(void *,ptcb,offsetof(GS_TCB, TCB_NextTCB)) != (void *) 0) 
// 18-06-2024 			get_pointed_offset(struct gs_tcb *,get_pointed_offset(struct gs_tcb *,ptcb,offsetof(GS_TCB, TCB_NextTCB)),offsetof(GS_TCB, TCB_PrevTCB)) = ptcb;
// 18-06-2024 		// ptcb1->TCB_NextTCB = ptcb;
// 18-06-2024 		get_pointed_offset(struct gs_tcb *,ptcb1,offsetof(GS_TCB, TCB_NextTCB)) = ptcb;
// 18-06-2024 		// ptcb->TCB_PrevTCB = (struct gs_tcb *) ptcb1;
// 18-06-2024 		get_pointed_offset(void *,ptcb,offsetof(GS_TCB, TCB_PrevTCB)) = ptcb1;
// 18-06-2024 	}
// 18-06-2024     return(G_TRUE);
// 18-06-2024 }
...
G_INT32  gk_TCBRUNL_Unlink(GS_TCB *ptcb)
{
    ...
    if (CPU_ID != GRTOS_CMD_PRC_ID ) {
        GRTOS_CMD_PRC_INT(CPU_ID);       
    }
    
    if (g_kcb.G_PCBTbl[CPU_ID - 1].PCBState != GS_PCBState_FREE)
		gk_LCBFPL_Link(CPU_ID);  // Link processor to free list

    // 19-06-2024 if (get_pointed_field(RunList,LCB_NextTCBRUNL) == ptcb){ // checks if it is the first TCP in RUNNING LIST
    // 19-06-2024 	set_pointed_field(RunList, LCB_NextTCBRUNL, (GS_TCB *) get_pointed_field(ptcb,TCB_NextTCB)); 
    // 19-06-2024 	if (get_pointed_field(RunList, LCB_NextTCBRUNL) != (struct gs_tcb *) 0) /* It is not the only element */
    // 19-06-2024 	{
    // 19-06-2024 		set_pointed_field(RunList->LCB_NextTCBRUNL, TCB_PrevTCB, (struct gs_tcb *) 0);
    // 19-06-2024 	}
    // 19-06-2024 }
    // 19-06-2024 else
    // 19-06-2024 {
    // 19-06-2024 	/* It is not the first element in the list */
	// 19-06-2024 	set_pointed_field(ptcb->TCB_PrevTCB, TCB_NextTCB, ptcb->TCB_NextTCB); 
	// 19-06-2024 	if (get_pointed_field(ptcb, TCB_NextTCB) != (GS_TCB *)0) set_pointed_field(ptcb->TCB_NextTCB, TCB_PrevTCB, ptcb->TCB_PrevTCB); 
    // 19-06-2024 }
...
// 15-07-2024 /**gk_RRDSASL_Link
// 15-07-2024  *  \brief 
// 15-07-2024  *  Links SCB to RRDS Associated Signal List
// 15-07-2024  *  \param [in] prrds   Pointer to the RRDS
// 15-07-2024  *  \param [in] psignal Pointer to the SCB of the signal
// 15-07-2024  *  \return G_TRUE when successful, G_FALSE otherwise
// 15-07-2024  *  \relates Signal
// 15-07-2024  */ 
// 15-07-2024 G_INT32 gk_RRDSASL_Link(GS_RRDS *prrds, GS_SCB *psignal)
// 15-07-2024 {
// 15-07-2024 	set_pointed_field(psignal,SCBState, G_SCBState_IN_TCB);
// 15-07-2024 	// 19-06-2024 return gk_SCB_Link(&prrds->RRDS_NextSCB, psignal, G_SCBState_IN_TCB, offsetof(GS_SCB, SCBType));
// 15-07-2024 	return	(gk_NODE_Link((void **) &prrds->RRDS_NextSCB,        // root to the ready list
// 15-07-2024 		                 (void *) psignal,                      // node to link
// 15-07-2024 					     offsetof(GS_SCB, SCB_NextSCB),         // next field offset
// 15-07-2024 					     offsetof(GS_SCB, SCB_NextSCB),         // previous field offset
// 15-07-2024 					     offsetof(GS_SCB, SCBType),             // comparison field offset
// 15-07-2024 					     G_FALSE,                               // dual-linked list
// 15-07-2024 					     G_FALSE,                               // 64-bit comparison field
// 15-07-2024 					     G_TRUE));                               // ascending order sorting
// 15-07-2024 }

// 11-06-2024 G_INT32 gk_RRDSASL_Link(GS_RRDS *prrds, GS_SCB *psignal)
// 11-06-2024 {
// 11-06-2024     GK_SAMPLE_FUNCTION_BEGIN(49)
// 11-06-2024     G_INT32 priority = psignal->SCBType;
// 11-06-2024     GS_SCB *psignal2;
// 11-06-2024 
// 11-06-2024     if ((prrds->RRDS_NextSCB == (struct gs_scb *) 0) || (prrds->RRDS_NextSCB->SCBType > priority))
// 11-06-2024     {
// 11-06-2024         // it is the only SCB associated to pevent
// 11-06-2024     	psignal->SCB_NextSCB = (struct gs_scb *) prrds->RRDS_NextSCB;
// 11-06-2024     	prrds->RRDS_NextSCB  = (struct gs_scb *) psignal;
// 11-06-2024     }
// 11-06-2024 	else
// 11-06-2024 	{
// 11-06-2024 		// Sort by priotiy
// 11-06-2024 		psignal2 = prrds->RRDS_NextSCB;
// 11-06-2024 		while ((psignal2->SCB_NextSCB != (struct gs_scb *) 0) && (psignal2->SCB_NextSCB->SCBType <= priority))
// 11-06-2024 		{
// 11-06-2024 			psignal2 = psignal2->SCB_NextSCB;
// 11-06-2024 		}
// 11-06-2024 		PRINT_ASSERT((gkm_SCB_IsValid(psignal2) == G_TRUE),"ERROR psignal in gk_RRDSASL_Link\n");
// 11-06-2024 		psignal->SCB_NextSCB  = psignal2->SCB_NextSCB;
// 11-06-2024 		psignal2->SCB_NextSCB = (struct gs_scb *) psignal;
// 11-06-2024     }
// 11-06-2024 	
// 11-06-2024 	psignal->SCBState = G_SCBState_IN_TCB;
// 11-06-2024     GK_SAMPLE_FUNCTION_END(49)
// 11-06-2024     return(G_TRUE);
// 11-06-2024 }

// 15-07-2024 /**gk_RRDSASL_UnLink
// 15-07-2024  *  \brief 
// 15-07-2024  *  Unlinks SCB from RRDS Associated Signal List
// 15-07-2024  *  \param [in] prrds   Pointer to RRDS
// 15-07-2024  *  \param [in] psignal Pointer to SCB
// 15-07-2024  *  \return G_TRUE when successful, G_FALSE otherwise
// 15-07-2024  *  \todo Check if it is linked and return G_FALSE if it is not
// 15-07-2024  *  \relates RRSD
// 15-07-2024  */ 
// 15-07-2024 G_INT32  gk_RRDSASL_UnLink(GS_RRDS *prrds, GS_SCB *psignal)
// 15-07-2024 {
// 15-07-2024     GK_SAMPLE_FUNCTION_BEGIN(50)
// 15-07-2024 	// 02-07-2024 GS_SCB *psignal1;
// 15-07-2024 	G_INT32 retorno = G_FALSE;
// 15-07-2024 
// 15-07-2024     PRINT_ASSERT((psignal->SCBState != G_SCBState_UNLINKED),"ERROR SCBState= %d\n", (int) psignal->SCBState);
// 15-07-2024 
// 15-07-2024 	// 12-06-2024 if (prrds->RRDS_NextSCB != (struct gs_scb *) 0)
// 15-07-2024 	// 12-06-2024 {
// 15-07-2024 	
// 15-07-2024 	// 19-06-2024 retorno = gk_SCB_SCBL_Unlink((GS_SCB **) &prrds->RRDS_NextSCB, psignal);
// 15-07-2024 	
// 15-07-2024 	retorno = gk_NODE_SINGLE_Unlink((void **) &prrds->RRDS_NextSCB,           // root to the ready list
// 15-07-2024 	                                (void *) psignal,                         // node to link
// 15-07-2024 									(G_INT32)  offsetof(GS_SCB,SCB_NextSCB)); // next field offset
// 15-07-2024 	if (retorno == G_TRUE) {
// 15-07-2024 		psignal->SCBState = G_SCBState_UNLINKED;
// 15-07-2024 	}	
// 15-07-2024 	
// 15-07-2024 		// 12-06-2024 if (prrds->RRDS_NextSCB == psignal)
// 15-07-2024 		// 12-06-2024 {
// 15-07-2024 		// 12-06-2024 	prrds->RRDS_NextSCB = psignal->SCB_NextSCB;
// 15-07-2024 		// 12-06-2024 }
// 15-07-2024 		// 12-06-2024 else
// 15-07-2024 		// 12-06-2024 {
// 15-07-2024 		// 12-06-2024 	psignal1 = prrds->RRDS_NextSCB;
// 15-07-2024 		// 12-06-2024 	while ((psignal1->SCB_NextSCB != (struct gs_scb *) 0) && (psignal1->SCB_NextSCB != psignal))
// 15-07-2024 		// 12-06-2024 	{
// 15-07-2024 		// 12-06-2024 		psignal1 = psignal1->SCB_NextSCB;
// 15-07-2024 		// 12-06-2024 	}
// 15-07-2024 		// 12-06-2024 	PRINT_ASSERT((gkm_SCB_IsValid(psignal1) == G_TRUE),"ERROR psignal in gk_RRDSASL_UnLink\n");
// 15-07-2024 		// 12-06-2024 	psignal1->SCB_NextSCB = psignal->SCB_NextSCB;
// 15-07-2024 		// 12-06-2024 }
// 15-07-2024 		// 12-06-2024 psignal->SCBState = G_SCBState_UNLINKED;
// 15-07-2024 	// 12-06-2024 }
// 15-07-2024 
// 15-07-2024     PRINT_ASSERT((psignal->SCBState == G_SCBState_UNLINKED),"ERROR psignal->SCBState= %d\n",psignal->SCBState);
// 15-07-2024 
// 15-07-2024     GK_SAMPLE_FUNCTION_END(50)
// 15-07-2024     return(retorno);
// 15-07-2024 }
...
GS_TCB *gk_PCB_GetNextTCB(void)
{
    ...
    if (get_pointed_field(ppcb, PCBState) == GS_PCBState_FREE) { // It is not executing a main list task
        ...
        // PRINT_ASSERT((g_kcb.G_PCBTbl[GRTOS_CMD_PRC_ID -1].PCB_AssocLCB->PCB_RDY_LCBL == ptcb->TCB_RDY_LCB_Index),"ERROR LCB not valid\n");
...
// 10-06-2024 GS_SCB *gk_TCBPSL_GetSCB(GS_TCB *ptcb, G_INT32 SignalType)
// 10-06-2024 {
// 10-06-2024     GK_SAMPLE_FUNCTION_BEGIN(62)
// 10-06-2024 	GS_SCB *psignal = (GS_SCB *) 0;
// 10-06-2024 	GS_SCB *psignal1 = (GS_SCB *) ptcb->TCB_NextTCBPSL;
// 10-06-2024 
...
// 10-06-2024     	else
// 10-06-2024     	{
// 10-06-2024     		psignal1 = psignal1->SCB_NextSCB;
// 10-06-2024     	}
// 10-06-2024     }
// 10-06-2024     GK_SAMPLE_FUNCTION_END(62)
// 10-06-2024 	return(psignal);
// 10-06-2024 }

// 15-07-2024 /**gk_RRDSASL_GetSCB
// 15-07-2024  *  \brief 
// 15-07-2024  *  Returns pointer to the SCB linked in the RRDSASL list
// 15-07-2024  *  \param [in] prrds      Pointer to the RRDS
// 15-07-2024  *  \param [in] SignalType Type of signal to search in the list
// 15-07-2024  *  \return Pointer to the SCB with the type searched
// 15-07-2024  *  \todo Check if this function is necessary and valid for the union RRDS
// 15-07-2024  *  \relates Signal
// 15-07-2024  *  \sa RRDS
// 15-07-2024  */
// 15-07-2024 inline GS_SCB *gk_RRDSASL_GetSCB(GS_RRDS *prrds, G_INT32 SignalType)
// 15-07-2024 {
// 15-07-2024 	return (gk_GetSCB_from_list(prrds->RRDS_NextSCB, SignalType));
// 15-07-2024 }
// 10-06-2024 GS_SCB *gk_RRDSASL_GetSCB(GS_RRDS *prrds, G_INT32 SignalType)
// 10-06-2024 {
// 10-06-2024     GK_SAMPLE_FUNCTION_BEGIN(63)
// 10-06-2024 	GS_SCB *psignal = (struct gs_scb *) 0;
// 10-06-2024 	GS_SCB *psignal1 = prrds->RRDS_NextSCB;
// 10-06-2024 
// 10-06-2024     while (psignal1 != (struct gs_scb *) 0)
// 10-06-2024     {
// 10-06-2024     	if (psignal1->SCBType == SignalType)
...
// 10-06-2024     	}
// 10-06-2024     }
// 10-06-2024     GK_SAMPLE_FUNCTION_END(63)
// 10-06-2024 	return(psignal);
// 10-06-2024 }
...
// 10-06-2024 GS_SCB *gk_KCBASL_GetSCB(G_INT32 SignalType)
// 10-06-2024 {
// 10-06-2024     GK_SAMPLE_FUNCTION_BEGIN(64)
// 10-06-2024 	GS_SCB *psignal = (struct gs_scb *) 0;
// 10-06-2024 	GS_SCB *psignal1 = g_kcb.KCB_NextKCBASL;
// 10-06-2024 
// 10-06-2024     while (psignal1 != (struct gs_scb *) 0)
// 10-06-2024     {
// 10-06-2024     	if (psignal1->SCBType == SignalType)
...
// 10-06-2024     	}
// 10-06-2024     }
// 10-06-2024     GK_SAMPLE_FUNCTION_END(64)
// 10-06-2024 	return(psignal);
// 10-06-2024 }
...
// 10-06-2024 GS_SCB *gk_TCBASL_GetSCB(GS_TCB *ptcb, G_INT32 SignalType)
// 10-06-2024 {
// 10-06-2024     GK_SAMPLE_FUNCTION_BEGIN(10041)
// 10-06-2024 	GS_SCB *psignal = (GS_SCB *) 0;
// 10-06-2024 	GS_SCB *psignal1 = (GS_SCB *) get_pointed_field(ptcb, TCB_NextTCBASL);
// 10-06-2024 
// 10-06-2024     while (psignal1 != (struct gs_scb *) 0)
// 10-06-2024     {
// 10-06-2024     	if (get_pointed_field(psignal1, SCBType) == SignalType)
// 10-06-2024     	{
// 10-06-2024     		psignal = psignal1;
// 10-06-2024     		psignal1 = (struct gs_scb *) 0;
// 10-06-2024     	}
// 10-06-2024     	else
// 10-06-2024     	{
// 10-06-2024     		psignal1 = get_pointed_field(psignal1, SCB_NextSCB);
// 10-06-2024     	}
// 10-06-2024     }
// 10-06-2024     GK_SAMPLE_FUNCTION_END(10041)
// 10-06-2024 	return(psignal);
// 10-06-2024 }
 ...
 *  \param [in] prcb       Pointer to the SCB linked list
 *  \param [in] SignalType Signal Type og the signal
...
G_INT32 get_CPU_ID(void)
{
	return ((G_INT32) (*((volatile unsigned int *) GRTOS_DRIVER_GRTOS_PROCESSOR_BASE1 + ADDR_REG_1)));
}
