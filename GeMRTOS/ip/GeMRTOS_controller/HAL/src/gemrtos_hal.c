...
void gu_printf(char *format, ...) 
{
	...
	if (gu_sem_wait(gu_printf_sem, (int) G_TRUE) == G_TRUE) {
		...
		// 23-02-2024 	GRTOS_USER_CRITICAL_SECTION_GET;
		// 23-02-2024 }
		...
		// 23-02-2024 	GRTOS_USER_CRITICAL_SECTION_RELEASE;
		// 23-02-2024 }
...
void gu_fprintf(char *format, ...) 
{
    ...
    if (gu_sem_wait(gu_fprintf_sem, (int) G_TRUE) == G_TRUE) {

		// 02-01-2024 if (g_kcb.G_PCBTbl[GRTOS_CMD_PRC_ID-1].PCB_Critical_PCB == G_FALSE) {
		// 02-01-2024     GRTOS_USER_CRITICAL_SECTION_GET;
		// 02-01-2024 }
		...
		// 02-01-2024 if (g_kcb.G_PCBTbl[GRTOS_CMD_PRC_ID-1].PCB_Critical_PCB == G_FALSE) {
		// 02-01-2024     GRTOS_USER_CRITICAL_SECTION_RELEASE;
		// 02-01-2024 }
		// GU_SAMPLE_FUNCTION_END();
		
		gu_sem_post((G_RCB *) gu_fprintf_sem);
	}
}
