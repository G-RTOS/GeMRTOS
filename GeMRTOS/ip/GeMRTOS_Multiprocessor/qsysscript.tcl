...
set fp [open "logging.log" w+]
    ...
    foreach instance $instances {
        ...
        foreach subinstance [get_composed_instances $instance] {
            ...
            if { [ string first "rstaux_memory" $subinstance ] != -1} {
                set rstmem "add_section_mapping rstaux ${instance}_${subinstance}"
                puts " add_section_mapping rstaux ${instance}_${subinstance}"
            }
            if { [ string first "onchip_memory2_2" $subinstance ] != -1} {
				set command1 "delete_memory_region ${instance}_${subinstance}"
				set command2 "add_memory_region onchipdata ${instance}_${subinstance} 0 512"
				set command3 "add_memory_region onchipcode ${instance}_${subinstance} 512 15872"
				set command4 "add_section_mapping onchipdata onchipdata"
				set command5 "add_section_mapping onchipmem onchipcode"
                # set onchipmem "add_section_mapping onchipmem ${instance}_${subinstance}"
                puts " add_section_mapping onchipmem ${instance}_${subinstance}"
            }
...
# --cmd \"set_setting hal.custom_newlib_flags \-D__DYNAMIC_REENT__\"
