...
set_parameter_property Processor_type ALLOWED_RANGES {"Nios II/e (economy)" "Nios II/f (full)" "Nios V/m"}
set_parameter_property Processor_type HDL_PARAMETER false

# ############################################################################
# Processor Reset vector memory
add_parameter resetSlave STRING "Internal GeMRTOS (default)" "Reset vector memory"
...
proc validate { } {
	...
	if {[ file exists "./devices/${DEVICE_NAME}/grtos.qxp" ] == 1 } {	
		file copy -force ./devices/${DEVICE_NAME}/grtos.qxp ../GeMRTOS_controller
	} else {
		send_message Error "Device ${DEVICE_NAME} not found for GeMRTOS. Please, request it to contact@gemrtos.com."
	}
...
proc compose { } {
	...
	# Include STDIO, STDERR and processor JTAG UART
    ...
    add_instance rstaux_memory altera_avalon_onchip_memory2
    set_instance_parameter_value rstaux_memory {allowInSystemMemoryContentEditor} {0}
    set_instance_parameter_value rstaux_memory {blockType} {AUTO}
    set_instance_parameter_value rstaux_memory {copyInitFile} {0}
    set_instance_parameter_value rstaux_memory {dataWidth} {32}
    set_instance_parameter_value rstaux_memory {dataWidth2} {32}
    set_instance_parameter_value rstaux_memory {dualPort} {0}
    set_instance_parameter_value rstaux_memory {ecc_enabled} {0}
    set_instance_parameter_value rstaux_memory {enPRInitMode} {0}
    set_instance_parameter_value rstaux_memory {enableDiffWidth} {0}
    set_instance_parameter_value rstaux_memory {initMemContent} {1}
    set_instance_parameter_value rstaux_memory {initializationFileName} {GRTOS_Multiprocessor_0_rstaux_memory.hex}
    set_instance_parameter_value rstaux_memory {instanceID} {NONE}
    set_instance_parameter_value rstaux_memory {memorySize} {512.0}
    set_instance_parameter_value rstaux_memory {readDuringWriteMode} {DONT_CARE}
    set_instance_parameter_value rstaux_memory {resetrequest_enabled} {1}
    set_instance_parameter_value rstaux_memory {simAllowMRAMContentsFile} {0}
    set_instance_parameter_value rstaux_memory {simMemInitOnlyFilename} {0}
    set_instance_parameter_value rstaux_memory {singleClockOperation} {0}
    set_instance_parameter_value rstaux_memory {slave1Latency} {1}
    set_instance_parameter_value rstaux_memory {slave2Latency} {1}
    set_instance_parameter_value rstaux_memory {useNonDefaultInitFile} {0}
    set_instance_parameter_value rstaux_memory {useShallowMemBlocks} {0}
    set_instance_parameter_value rstaux_memory {writable} {1}
    # CLOCK and RESET
    add_connection clock_bridge_0.out_clk rstaux_memory.clk1 clock
    add_connection reset_bridge_0.out_reset rstaux_memory.reset1 reset
    ...
    # # Memory for Code on-chip
    add_instance onchip_memory2_2 altera_avalon_onchip_memory2
    ...
    set_instance_parameter_value onchip_memory2_2 {memorySize} {16384.0}
    ...
    for {set i 1} {$i <= $Processors} {incr i} {
		...
		# #########################################################
		if { ($Type_of_Processor == "Nios V/m") } {
			add_instance gemrtos_proc_${i} intel_niosv_m 1.0.0
...
# 31/10/2023 #############################################	
    ...
    for {set i 1} {$i <= $Processors} {incr i} {
        ...
        set address_base [ get_connection_parameter_value master_0.master/onchip_memory2_2.s1 baseAddress ]
        set_connection_parameter_value nios_avalon_monitor.m${i}/onchip_memory2_2.s1 baseAddress $address_base
    ...
    if { [get_parameter_value ENABLE_HPS_MAP_ACCESS ] } {
        ...
        set address_base [ get_connection_parameter_value master_0.master/onchip_memory2_2.s1 baseAddress ]
        set_connection_parameter_value mm_clock_crossing_bridge_0.m0/onchip_memory2_2.s1 baseAddress $address_base
        set_connection_parameter_value mm_clock_crossing_bridge_0.m0/onchip_memory2_2.s1 defaultConnection {0}        
    }
    set ancho [get_instance_interface_property onchip_memory2_2 s1 addressSpan ]
    send_message Debug "Span of onchip_memory2_2 s1 is $ancho, base address is $BaseAddress"
    set BaseAddress [expr {$BaseAddress + $ancho}]
...
# #########################################################    
    ...
    # Connection of rstaux_memory at $BaseAddress span 0x800
    add_connection master_0.master rstaux_memory.s1 avalon
    set_connection_parameter_value master_0.master/rstaux_memory.s1 arbitrationPriority {1}
    set_connection_parameter_value master_0.master/rstaux_memory.s1 baseAddress $BaseAddress
    set_connection_parameter_value master_0.master/rstaux_memory.s1 defaultConnection {0}
    for {set i 1} {$i <= $Processors} {incr i} {
        add_connection nios_avalon_monitor.m$i rstaux_memory.s1 avalon
        set_connection_parameter_value nios_avalon_monitor.m${i}/rstaux_memory.s1 arbitrationPriority {1}
        set address_base [ get_connection_parameter_value master_0.master/rstaux_memory.s1 baseAddress ]
        set_connection_parameter_value nios_avalon_monitor.m${i}/rstaux_memory.s1 baseAddress $address_base
        set_connection_parameter_value nios_avalon_monitor.m${i}/rstaux_memory.s1 defaultConnection {0}
    }
    # HPS internal access
    if { [get_parameter_value ENABLE_HPS_MAP_ACCESS ] } {
        add_connection mm_clock_crossing_bridge_0.m0 rstaux_memory.s1 avalon
        set_connection_parameter_value mm_clock_crossing_bridge_0.m0/rstaux_memory.s1 arbitrationPriority {1}
        set address_base [ get_connection_parameter_value master_0.master/rstaux_memory.s1 baseAddress ]
        set_connection_parameter_value mm_clock_crossing_bridge_0.m0/rstaux_memory.s1 baseAddress $address_base
        set_connection_parameter_value mm_clock_crossing_bridge_0.m0/rstaux_memory.s1 defaultConnection {0}        
    }
    # set ancho [get_instance_interface_properties rstaux_memory s1 ]
    # send_message Debug $ancho
    set ancho [get_instance_interface_property rstaux_memory s1 addressSpan ]
    send_message Debug "Span of rstaux_memory is $ancho, base address is $BaseAddress"
...
# ########################################
    ...
    send_message Debug "Span of sysid_qsys_0 control_slave is $ancho, $unidades, base address is $BaseAddress"
    set BaseAddress [expr {$BaseAddress + $ancho}]      
    ...
    add_connection grtos_0.slv_rst1 rstaux_memory.reset1 reset
