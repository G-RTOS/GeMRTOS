...
#define ADDR_CLOCK_FREQUENCY    32
#define ADDR_HLT_ACT_CNT        33
...
#define IORD_GRTOS_CLOCK_FREQUENCY               IORD(GRTOS_DRIVER_GRTOS_BASE, ADDR_CLOCK_FREQUENCY)
#define IORD_GRTOS_HLT_ACT_CNT                   IORD(GRTOS_DRIVER_GRTOS_BASE, ADDR_HLT_ACT_CNT)
