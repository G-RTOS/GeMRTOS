...
{
	G_INT64 temp_aux;
	// 13-09-2024 !!!!D G_INT64 hours_64 = ;
	// 13-09-2024 !!!!D G_INT64 minutes_64 = ;
	// 13-09-2024 !!!!D G_INT64 seconds_64 = ;
	// 13-09-2024 !!!!D G_INT64 ms_64 = ;
...
***********************************************************************************/
/**gu_TaskTypeSet
 *  \brief The gu_TaskTypeSet function sets the type of a task.  The valid task types are G_TCBType_PERIODIC and G_TCBType_UCOS.
 ...
 *  \param [in] type The type must be either G_TCBType_PERIODIC or G_TCBType_UCOS. Any other value will result in failure.
