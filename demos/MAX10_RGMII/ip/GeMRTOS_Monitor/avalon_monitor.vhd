...
--  \brief GeMRTOS Avalon-MM monitor RTL
--  \details Bus monitor used by the GeMRTOS Monitor IP component.
--  \version 1.0
--  \date      2013-2026
--
...
entity avalon_monitor is
	...
	port (
		...
		frozen_avalon_monitor_controller  : out std_logic;
        frozen_avalon_controller_monitor  : in std_logic;
        
		-- Avalon Slave port to Access monitor Registers
	    slave_AvalonMonitor_chipselect    : in std_logic;		
		slave_AvalonMonitor_address       : in std_logic_vector(1 downto 0);
...
component STD_FIFO is
    ...
    signal PROCESSOR_SELECTED  : unsigned (4 downto 0);

    signal R_RESET_OFFSET   : unsigned (m1_address'left downto 0);
    signal R_RESET_ADDRESS  : unsigned (m1_address'left downto 0);
    constant RESET_SPAN     : unsigned (m1_address'left downto 0) := to_unsigned(16, R_RESET_ADDRESS'length);
...
begin
	...
	begin 
        ...
        frozen_avalon_monitor_controller <= frozen_out_i;
		if ENABLE_MONITORING = 0 then
			frozen_avalon_monitor_controller <= '0';
		end if;
    end process;
    -- #######################################################################################################################
...
ENABLE_MONITORING_if: if ENABLE_MONITORING = 1 generate
    ...
    i1_read_fifo <=  '1' when i1_empty = '0' and R_CTRL(2) = '1' else '1' when  i1_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 0, PROCESSOR_SELECTED'length) else '0';
    i2_read_fifo <=  '1' when i2_empty = '0' and R_CTRL(2) = '1' else '1' when  i2_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 1, PROCESSOR_SELECTED'length) else '0';
    i3_read_fifo <=  '1' when i3_empty = '0' and R_CTRL(2) = '1' else '1' when  i3_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 2, PROCESSOR_SELECTED'length) else '0';
    i4_read_fifo <=  '1' when i4_empty = '0' and R_CTRL(2) = '1' else '1' when  i4_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 3, PROCESSOR_SELECTED'length) else '0';
    i5_read_fifo <=  '1' when i5_empty = '0' and R_CTRL(2) = '1' else '1' when  i5_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 4, PROCESSOR_SELECTED'length) else '0';
    i6_read_fifo <=  '1' when i6_empty = '0' and R_CTRL(2) = '1' else '1' when  i6_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 5, PROCESSOR_SELECTED'length) else '0';
    i7_read_fifo <=  '1' when i7_empty = '0' and R_CTRL(2) = '1' else '1' when  i7_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 6, PROCESSOR_SELECTED'length) else '0';
    i8_read_fifo <=  '1' when i8_empty = '0' and R_CTRL(2) = '1' else '1' when  i8_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 7, PROCESSOR_SELECTED'length) else '0';
    i9_read_fifo <=  '1' when i9_empty = '0' and R_CTRL(2) = '1' else '1' when  i9_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1'  and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 8, PROCESSOR_SELECTED'length) else '0';
    i10_read_fifo <= '1' when i10_empty = '0' and R_CTRL(2) = '1' else '1' when i10_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned( 9, PROCESSOR_SELECTED'length) else '0';    
    i11_read_fifo <= '1' when i11_empty = '0' and R_CTRL(2) = '1' else '1' when i11_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(10, PROCESSOR_SELECTED'length) else '0';
    i12_read_fifo <= '1' when i12_empty = '0' and R_CTRL(2) = '1' else '1' when i12_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(11, PROCESSOR_SELECTED'length) else '0';
    i13_read_fifo <= '1' when i13_empty = '0' and R_CTRL(2) = '1' else '1' when i13_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(12, PROCESSOR_SELECTED'length) else '0';
    i14_read_fifo <= '1' when i14_empty = '0' and R_CTRL(2) = '1' else '1' when i14_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(13, PROCESSOR_SELECTED'length) else '0';
    i15_read_fifo <= '1' when i15_empty = '0' and R_CTRL(2) = '1' else '1' when i15_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(14, PROCESSOR_SELECTED'length) else '0';
    i16_read_fifo <= '1' when i16_empty = '0' and R_CTRL(2) = '1' else '1' when i16_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(15, PROCESSOR_SELECTED'length) else '0';
    i17_read_fifo <= '1' when i17_empty = '0' and R_CTRL(2) = '1' else '1' when i17_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(16, PROCESSOR_SELECTED'length) else '0';
    i18_read_fifo <= '1' when i18_empty = '0' and R_CTRL(2) = '1' else '1' when i18_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(17, PROCESSOR_SELECTED'length) else '0';
    i19_read_fifo <= '1' when i19_empty = '0' and R_CTRL(2) = '1' else '1' when i19_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(18, PROCESSOR_SELECTED'length) else '0';
    i20_read_fifo <= '1' when i20_empty = '0' and R_CTRL(2) = '1' else '1' when i20_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(19, PROCESSOR_SELECTED'length) else '0';    
    i21_read_fifo <= '1' when i21_empty = '0' and R_CTRL(2) = '1' else '1' when i21_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(20, PROCESSOR_SELECTED'length) else '0';
    i22_read_fifo <= '1' when i22_empty = '0' and R_CTRL(2) = '1' else '1' when i22_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(21, PROCESSOR_SELECTED'length) else '0';
    i23_read_fifo <= '1' when i23_empty = '0' and R_CTRL(2) = '1' else '1' when i23_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(22, PROCESSOR_SELECTED'length) else '0';
    i24_read_fifo <= '1' when i24_empty = '0' and R_CTRL(2) = '1' else '1' when i24_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(23, PROCESSOR_SELECTED'length) else '0';
    i25_read_fifo <= '1' when i25_empty = '0' and R_CTRL(2) = '1' else '1' when i25_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(24, PROCESSOR_SELECTED'length) else '0';
    i26_read_fifo <= '1' when i26_empty = '0' and R_CTRL(2) = '1' else '1' when i26_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(25, PROCESSOR_SELECTED'length) else '0';
    i27_read_fifo <= '1' when i27_empty = '0' and R_CTRL(2) = '1' else '1' when i27_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(26, PROCESSOR_SELECTED'length) else '0';
    i28_read_fifo <= '1' when i28_empty = '0' and R_CTRL(2) = '1' else '1' when i28_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(27, PROCESSOR_SELECTED'length) else '0';
    i29_read_fifo <= '1' when i29_empty = '0' and R_CTRL(2) = '1' else '1' when i29_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(28, PROCESSOR_SELECTED'length) else '0';
    i30_read_fifo <= '1' when i30_empty = '0' and R_CTRL(2) = '1' else '1' when i30_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(29, PROCESSOR_SELECTED'length) else '0';    
    i31_read_fifo <= '1' when i31_empty = '0' and R_CTRL(2) = '1' else '1' when i31_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(30, PROCESSOR_SELECTED'length) else '0';
    i32_read_fifo <= '1' when i32_empty = '0' and R_CTRL(2) = '1' else '1' when i32_almost_full = '1' and R_CTRL(0) = '0' else '1' when slave_AvalonMonitor_read = '0' and prev_AvalonMonitor_read = '1' and prev_AvalonMonitor_address = ADDR_FIFO_0 and PROCESSOR_SELECTED = to_unsigned(31, PROCESSOR_SELECTED'length) else '0';

    i_frozzen(1)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i1_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i1_address_prev /=  s1_address and  s1_read = '1' else '0';
    i_frozzen(2)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i2_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i2_address_prev /=  s2_address and  s2_read = '1' else '0';
    i_frozzen(3)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i3_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i3_address_prev /=  s3_address and  s3_read = '1' else '0';
    i_frozzen(4)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i4_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i4_address_prev /=  s4_address and  s4_read = '1' else '0';
    i_frozzen(5)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i5_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i5_address_prev /=  s5_address and  s5_read = '1' else '0';
    i_frozzen(6)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i6_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i6_address_prev /=  s6_address and  s6_read = '1' else '0';
    i_frozzen(7)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i7_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i7_address_prev /=  s7_address and  s7_read = '1' else '0';
    i_frozzen(8)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i8_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i8_address_prev /=  s8_address and  s8_read = '1' else '0';
    i_frozzen(9)    <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i9_full = '1'  and R_CTRL(0) = '1') or R_CTRL(1) = '1') and  i9_address_prev /=  s9_address and  s9_read = '1' else '0';
    i_frozzen(10)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i10_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i10_address_prev /= s10_address and s10_read = '1' else '0';    
    i_frozzen(11)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i11_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i11_address_prev /= s11_address and s11_read = '1' else '0';
    i_frozzen(12)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i12_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i12_address_prev /= s12_address and s12_read = '1' else '0';
    i_frozzen(13)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i13_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i13_address_prev /= s13_address and s13_read = '1' else '0';
    i_frozzen(14)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i14_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i14_address_prev /= s14_address and s14_read = '1' else '0';
    i_frozzen(15)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i15_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i15_address_prev /= s15_address and s15_read = '1' else '0';
    i_frozzen(16)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i16_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i16_address_prev /= s16_address and s16_read = '1' else '0';
    i_frozzen(17)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i17_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i17_address_prev /= s17_address and s17_read = '1' else '0';
    i_frozzen(18)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i18_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i18_address_prev /= s18_address and s18_read = '1' else '0';
    i_frozzen(19)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i19_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i19_address_prev /= s19_address and s19_read = '1' else '0';
    i_frozzen(20)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i20_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i20_address_prev /= s20_address and s20_read = '1' else '0';    
    i_frozzen(21)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i21_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i21_address_prev /= s21_address and s21_read = '1' else '0';
    i_frozzen(22)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i22_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i22_address_prev /= s22_address and s22_read = '1' else '0';
    i_frozzen(23)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i23_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i23_address_prev /= s23_address and s23_read = '1' else '0';
    i_frozzen(24)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i24_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i24_address_prev /= s24_address and s24_read = '1' else '0';
    i_frozzen(25)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i25_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i25_address_prev /= s25_address and s25_read = '1' else '0';
    i_frozzen(26)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i26_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i26_address_prev /= s26_address and s26_read = '1' else '0';
    i_frozzen(27)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i27_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i27_address_prev /= s27_address and s27_read = '1' else '0';
    i_frozzen(28)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i28_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i28_address_prev /= s28_address and s28_read = '1' else '0';
    i_frozzen(29)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i29_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i29_address_prev /= s29_address and s29_read = '1' else '0';    
    i_frozzen(30)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i30_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i30_address_prev /= s30_address and s30_read = '1' else '0';    
    i_frozzen(31)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i31_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i31_address_prev /= s31_address and s31_read = '1' else '0';
    i_frozzen(32)   <= '1' when (R_CTRL(1) = '1' or frozen_avalon_controller_monitor = '1') else '1' when ((i32_full = '1' and R_CTRL(0) = '1') or R_CTRL(1) = '1') and i32_address_prev /= s32_address and s32_read = '1' else '0';


    slave_AvalonMonitor_readdata_int <= i1_data_out    when PROCESSOR_SELECTED = to_unsigned( 0, PROCESSOR_SELECTED'length) else
                                        i2_data_out    when PROCESSOR_SELECTED = to_unsigned( 1, PROCESSOR_SELECTED'length) else
                                        i3_data_out    when PROCESSOR_SELECTED = to_unsigned( 2, PROCESSOR_SELECTED'length) else
                                        i4_data_out    when PROCESSOR_SELECTED = to_unsigned( 3, PROCESSOR_SELECTED'length) else
                                        i5_data_out    when PROCESSOR_SELECTED = to_unsigned( 4, PROCESSOR_SELECTED'length) else
                                        i6_data_out    when PROCESSOR_SELECTED = to_unsigned( 5, PROCESSOR_SELECTED'length) else
                                        i7_data_out    when PROCESSOR_SELECTED = to_unsigned( 6, PROCESSOR_SELECTED'length) else
                                        i8_data_out    when PROCESSOR_SELECTED = to_unsigned( 7, PROCESSOR_SELECTED'length) else
                                        i9_data_out    when PROCESSOR_SELECTED = to_unsigned( 8, PROCESSOR_SELECTED'length) else
                                        i10_data_out   when PROCESSOR_SELECTED = to_unsigned( 9, PROCESSOR_SELECTED'length) else 
                                        i11_data_out   when PROCESSOR_SELECTED = to_unsigned(10, PROCESSOR_SELECTED'length) else
                                        i12_data_out   when PROCESSOR_SELECTED = to_unsigned(11, PROCESSOR_SELECTED'length) else
                                        i13_data_out   when PROCESSOR_SELECTED = to_unsigned(12, PROCESSOR_SELECTED'length) else
                                        i14_data_out   when PROCESSOR_SELECTED = to_unsigned(13, PROCESSOR_SELECTED'length) else
                                        i15_data_out   when PROCESSOR_SELECTED = to_unsigned(14, PROCESSOR_SELECTED'length) else
                                        i16_data_out   when PROCESSOR_SELECTED = to_unsigned(15, PROCESSOR_SELECTED'length) else
                                        i17_data_out   when PROCESSOR_SELECTED = to_unsigned(16, PROCESSOR_SELECTED'length) else
                                        i18_data_out   when PROCESSOR_SELECTED = to_unsigned(17, PROCESSOR_SELECTED'length) else
                                        i19_data_out   when PROCESSOR_SELECTED = to_unsigned(18, PROCESSOR_SELECTED'length) else
                                        i20_data_out   when PROCESSOR_SELECTED = to_unsigned(19, PROCESSOR_SELECTED'length) else
                                        i21_data_out   when PROCESSOR_SELECTED = to_unsigned(20, PROCESSOR_SELECTED'length) else
                                        i22_data_out   when PROCESSOR_SELECTED = to_unsigned(21, PROCESSOR_SELECTED'length) else
                                        i23_data_out   when PROCESSOR_SELECTED = to_unsigned(22, PROCESSOR_SELECTED'length) else
                                        i24_data_out   when PROCESSOR_SELECTED = to_unsigned(23, PROCESSOR_SELECTED'length) else
                                        i25_data_out   when PROCESSOR_SELECTED = to_unsigned(24, PROCESSOR_SELECTED'length) else
                                        i26_data_out   when PROCESSOR_SELECTED = to_unsigned(25, PROCESSOR_SELECTED'length) else
                                        i27_data_out   when PROCESSOR_SELECTED = to_unsigned(26, PROCESSOR_SELECTED'length) else
                                        i28_data_out   when PROCESSOR_SELECTED = to_unsigned(27, PROCESSOR_SELECTED'length) else
                                        i29_data_out   when PROCESSOR_SELECTED = to_unsigned(28, PROCESSOR_SELECTED'length) else
                                        i30_data_out   when PROCESSOR_SELECTED = to_unsigned(29, PROCESSOR_SELECTED'length) else
                                        i31_data_out   when PROCESSOR_SELECTED = to_unsigned(30, PROCESSOR_SELECTED'length) else
                                        i32_data_out   when PROCESSOR_SELECTED = to_unsigned(31, PROCESSOR_SELECTED'length) else 
                                        (others => '0');

Read_data: process (slave_AvalonMonitor_address, slave_AvalonMonitor_readdata_int, PROCESSOR_SELECTED) is
    begin
        slave_AvalonMonitor_readdata <= (others => '0');
        if (slave_AvalonMonitor_address = ADDR_FIFO_0) then
            slave_AvalonMonitor_readdata(slave_AvalonMonitor_readdata_int'left downto 0) <= slave_AvalonMonitor_readdata_int;
        end if;
        if (slave_AvalonMonitor_address = ADDR_FIFO_1) then
            slave_AvalonMonitor_readdata(PROCESSOR_SELECTED'left downto 0) <= std_logic_vector(PROCESSOR_SELECTED);
        end if;
        if (slave_AvalonMonitor_address = ADDR_FIFO_2) then
            slave_AvalonMonitor_readdata(R_CTRL'left downto 0) <= R_CTRL;
        end if;
    end process;     
...
Control_register:
    ...
    begin 
        if (reset = '1') then    
            R_CTRL <= (others => '0'); 
            PROCESSOR_SELECTED <= (others => '0'); 
            R_RESET_ADDRESS <= (others => '0'); 
            R_RESET_OFFSET <= (others => '0'); 
        elsif (clk'event and clk = '1') then
            if (slave_AvalonMonitor_write = '1' and slave_AvalonMonitor_address = ADDR_FIFO_0) then
                R_CTRL <= slave_AvalonMonitor_writedata;
            end if;
            if (slave_AvalonMonitor_write = '1' and slave_AvalonMonitor_address = ADDR_FIFO_1) then
                PROCESSOR_SELECTED <= unsigned(slave_AvalonMonitor_writedata(PROCESSOR_SELECTED'left downto 0));
            end if;
            if (slave_AvalonMonitor_write = '1' and 
                slave_AvalonMonitor_address = ADDR_FIFO_3 and
                slave_AvalonMonitor_writedata(31) = '0') then
                R_RESET_ADDRESS <= unsigned(slave_AvalonMonitor_writedata(R_RESET_ADDRESS'left - 2 downto 0) & "00");
            end if;            
            if (slave_AvalonMonitor_write = '1' and 
                slave_AvalonMonitor_address = ADDR_FIFO_3 and
                slave_AvalonMonitor_writedata(31) = '1') then
                R_RESET_OFFSET <= unsigned(slave_AvalonMonitor_writedata(R_RESET_OFFSET'left - 2 downto 0) & "00");
            end if;
        end if;
    end process; 
...
ENABLE_MONITORING_if0: if ENABLE_MONITORING = 0 generate
    ...
    m1_address        <= s1_address when unsigned(s1_address) < R_RESET_ADDRESS else
                         s1_address when unsigned(s1_address) >= R_RESET_ADDRESS + RESET_SPAN else
                         std_logic_vector(unsigned(s1_address) + R_RESET_OFFSET);
