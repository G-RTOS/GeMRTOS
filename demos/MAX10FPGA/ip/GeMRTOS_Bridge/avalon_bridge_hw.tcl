...
## \brief GeMRTOS bridge Platform Designer component descriptor
## \details Defines the GRTOS_Avalon_Bridge Qsys component: its parameters,
##          its per-processor Avalon-MM interfaces, and the elaborate{} callback
##          that generates them from the NProcessors parameter.
## \version 1.0
## \date      2013-2026
##
